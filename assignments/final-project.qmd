...
- Milestone 3: Add one polished data visualization on your distill article (10/27)
- Milestone 4: Add results from one set of analyses (11/10)
...
## Milestone 3: One data visualization (due 10/27)
...
## Milestone 4: Add results from one analysis (due 11/10)
